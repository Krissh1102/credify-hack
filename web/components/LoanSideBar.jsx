...
import { BarChart2, CalculatorIcon, FileTextIcon } from "lucide-react";
...
export const LoanSideBar = ({ open, setOpen }) => {
  const topLinks = [
    {
      label: " Loan Overview",
      href: "/loan-overview",
    ...
    { label: "My Loans", href: "/loans", icon: <IconWallet size={20} /> },
    {
      label: "Debt Overview",
      href: "/debt-overview",
    ...
    },
    {
      ...
      href: "/repayment",
      icon: <IconCalendarDollar size={20} />,
    },
    {
  ...
  const bottomLinks = [
    // {
    //   label: "Update Loan Info",
    //   href: "/loan-form",
    //   icon: <IconEdit size={20} />,
    // },
    { label: "Back to Home", href: "/", icon: <IconArrowBack size={20} /> },
  ];
