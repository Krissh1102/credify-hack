...
class DarkTokens {
  ...
  static const elevated = Color(0xFF1A1A26);
  static const border = Color(0xFF2A2A3A);
  static const accent = Color(0xFFD6AE7B); // was #F9B16E
  static const accentSoft = Color(0xFFEACDA3); // was #F68080
  ...
  static const textMuted = Color.fromARGB(255, 165, 165, 201);
  static const cardGrad1 = Color(0xFF1E1B4B);
  static const cardGrad2 = Color(0xFF181830);
}
